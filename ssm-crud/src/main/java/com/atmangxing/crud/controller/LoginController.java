...
public class LoginController {
    ...
    @RequestMapping(value = "/fileUploadController/{fileId}")
    public  String fileUploadController(@PathVariable Integer fileId,HttpSession session){
        session.setAttribute("fileId", fileId);
        session.setAttribute("wordname",wordServcie.getwordname(fileId));
        return "fileUpload";
    }
}