            ...
            <div class="modal-body">
                <form class="form-horizontal" id="addform" enctype="multipart/form-data" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">学&nbsp;&nbsp;号</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">作业号</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">作业名</label>
                        <div class="col-sm-10">
    ...
    $(document).on("click",".edit_btn",function(){
      ...
      /* $("#edit_update_static").text("");
       $("filename").attr("vaule","");
        ...
        window.location.href="${APP_PATH}/fileUploadController/"+$(this).attr("edit-id");
